...
abstract class CCodeModel extends CFormModel
{
	...
	public $template;
	/**
	 * @var array a list of {@link CCodesFile} objects that represent the code files to be generated.
	...
	{
		return array("default" => Yii::getPathOfAlias("cck.components.templates.default"));
	}
